...
def main():
    ...
    while 1:
        ...
        if showstartscreen == TRUE:
            ...
            text_surface = font.render("NAKE MACH", True, BLUE)
        ...
        while not snakedead:
            ...
            if gameregulator == 6:
                ...
                if snakexy[0] == applexy[0] and snakexy[1] == applexy[1]:
                    ...
                    if (effect==0) and ((speed<120) or (score>25)):
                        speed=speed+10
                        snakelist.pop()
                    else:
            ...
            text_surface = font.render("SNAKE MACH!", True, RED)
            screen.blit(text_surface, (50,18))
            font = pygame.font.SysFont("arial",30)
            if speed<120:
                text_surface = font.render("Score: " + str(score)+"   Speed:"+str(speed), True, BLUE)
                screen.blit(text_surface, (400,25))
            elif speed>120:
                text_surface = font.render("Score: " + str(score)+"   Speed: Plus Ultra", True, BLUE)
                screen.blit(text_surface, (400,25))
            else:
                text_surface = font.render("Score: " + str(score)+"   Speed: MAX", True, BLUE)
                screen.blit(text_surface, (400,25))


            ###### Snake Color
            colorchoices= [RED,YELLOW,ORANGE]
            ...
            for element in snakelist:
                if speed==120:
                    if shade==RED:
                        ...
                        shade=RED
                    pygame.draw.rect(screen,shade,Rect(element,BLOCKSIZE))
